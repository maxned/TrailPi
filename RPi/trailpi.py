...
# This script is in charge of running and stopping all of the TrailPi scripts
# and relaunching them if something crashes.
...
scripts = ["camera_manager.py", "image_capture.py", "image_upload.py", "check_in.py"]
